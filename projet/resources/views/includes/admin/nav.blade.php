    ...
    <div class="uk-navbar-right">
        ...
        <div uk-dropdown="pos: top-right ;mode : click ;animation: uk-animation-slide-bottom-small" class="uk-dropdown uk-padding-small angle-top-right uk-dropdown-bottom-right" >
            ...
            <ul class="uk-nav uk-dropdown-nav">
                <li>
                    <a href="/admin/profile"> <i class="fas fa-user uk-margin-small-right"></i> Profile</a>
                </li>
                <li>
                    <a href="/admin/logout"> <i class="fas fa-sign-out-alt uk-margin-small-right"></i> Log out</a>
                </li>
            </ul>
        </div>
    </div>
